...
@section('content')
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4" id="dpContainer" style="display: none;">
                        ...
                        <small class="text-muted">DP wajib 30% dari total jika total ≥ Rp 100,000.</small>
                    </div>
                </div>
    ...
    <script>
        ...
        `);
            ...
            const totalSebelumDp = subtotal + biayaDesain - diskon;
            ...
            if (dpValue === 0 && totalSebelumDp >= 100000) {
                dpValue = Math.round(totalSebelumDp * 0.3);
            }
        ...
        $('#btnSelesaiTransaksi').click(function() {
            ...
            if (totalAkhir >= 100000) {
                const requiredDp = Math.round(totalAkhir * 0.3);
                if (!dp || dp < requiredDp) {
                    Swal.fire('Error',
            ...
            Swal.fire({
                ...
                text: 'Transaksi telah disimpan dan pembayaran telah selesai.',
                icon: 'success',
        ...
        function updateDpField() {
            ...
            if (totalAkhir >= 100000) {
                ...
                // Hitung DP minimal 30%
                let dpMin = Math.round(totalAkhir * 0.3);
                let formattedDp = dpMin.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");

                // Isi DP ke 30% hanya jika belum pernah diubah manual
                ...
                dpInput.off('input').on('input', function() {
                    ...
                    // Jika dihapus atau diisi kurang dari 30%
                    if (inputValue === "") {
                ...
                // Sembunyikan DP jika total < 100.000
                dpField.fadeOut(200);
