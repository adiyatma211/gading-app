...
<head>
    ...
    <title>Dashboard - Gading Admin Dashboard</title>
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <div style="text-align: center; margin: 20px 0;">
                                <div id="current-time" style="font-weight: bold; font-size: 18px;"></div>
    ...
    function confirmLogout(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById('logout-form').submit(); // Kirim POST ke /logout
            }
        });
    }
</script>
